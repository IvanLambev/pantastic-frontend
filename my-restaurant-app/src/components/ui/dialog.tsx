...
function DialogContent({
  ...
  const handleScrollEventCapture = (event: React.UIEvent<HTMLDivElement>) => {
    event.stopPropagation()
  }

  const handleWheelEventCapture = (event: React.WheelEvent<HTMLDivElement>) => {
    event.stopPropagation()
  }
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        onScrollCapture={handleScrollEventCapture}
        onWheelCapture={handleWheelEventCapture}
        className={cn(
