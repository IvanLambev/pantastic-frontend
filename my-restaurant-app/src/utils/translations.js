...
export const translations = {
  ...
  cartSwitch: {
    success: "Количката беше прехвърлена успешно.",
    partialSuccess: "Част от продуктите бяха прехвърлени, но някои липсват в новия ресторант.",
    noMatches: "Не открихме съвпадащи продукти в новия ресторант.",
    missingItems: "Липсващи продукти: {items}",
    unmatchedAddons: "Някои добавки не са налични и бяха премахнати.",
    unmatchedRemovables: "Някои премахвания не са налични и бяха игнорирани.",
    error: {
      invalidPayload: "Невалидна заявка. Изпратете item_ids или cart_items.",
      sameRestaurant: "Текущият и новият ресторант не могат да са еднакви.",
      invalidSourceItems: "Някои продукти не принадлежат към текущия ресторант.",
      validation: "Невалидни данни. Проверете формата на заявката.",
      server: "Възникна грешка. Моля, опитайте отново."
    }
  },
  ...
  checkout: {
    ...
    cartWillBeCleared: "Моля, изберете нов ресторант.",
    changeAddressWarning: "Промяната на адреса за доставка може да изисква избор на друг ресторант и прехвърляне на продуктите.",
    distanceLimitExceeded: "Този ресторант доставя до максимум {maxDistance} км. Вашият адрес е на {distance} км. Моля, изберете друг адрес или друг ресторант.",
    distanceValidationPending: "Изчакване за потвърждение на разстоянието до адреса. Моля, опитайте след секунда.",
  ...
  restaurantSelector: {
    ...
    noRestaurantsFoundInRadius: "Не са намерени ресторанти в радиус от {radius} км от вашето местоположение. Моля, опитайте друг адрес или изберете ресторант ръчно.",
